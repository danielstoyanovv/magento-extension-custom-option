 ...
 */
class Dani_CustomOption_Model_Product_Type_Price extends Mage_Catalog_Model_Product_Type_Price
{
        ...
        if ($optionIds = $product->getCustomOption('option_ids')) {
            ...
            foreach (explode(',', $optionIds->getValue()) as $optionId) {
                if ($option = $product->getOptionById($optionId)) {
                    ...
                    #Zend_Debug::dump($rulePriceDiscounted[0]);
                    #Zend_Debug::dump($rulePriceDiscounted);
                    #die; 
